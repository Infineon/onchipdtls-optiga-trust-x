...
<ResourceModel:App xmi:version="2.0" xmlns:xmi="http://www.omg.org/XMI" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:ResourceModel="http://www.infineon.com/Davex/Resource.ecore" name="I2C_MASTER" URI="http://resources/4.1.20/app/I2C_MASTER/0" description="Configures a USIC channel to perform transfer &amp; receive operations using I2C protocol." mode="NOTSHARABLE" version="4.1.20" minDaveVersion="4.0.0" instanceLabel="i2c_master_0" appLabel="">
  ...
  <virtualSignals name="event_transmit_buffer" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_std_tx_int" hwSignal="transmit_buffer_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_std_receive" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_std_rx_int" hwSignal="standard_receive_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_alt_receive" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_alt_rx_int" hwSignal="alternate_receive_int" hwResource="//@hwResources.0"/>
  <virtualSignals name="event_fifo_transmit" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_fifo_tx_int" hwSignal="standard_transmit_buffer_int" hwResource="//@hwResources.0" required="false"/>
  <virtualSignals name="event_fifo_std_receive" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_fifo_rx_int" hwSignal="standard_receive_buffer_int" hwResource="//@hwResources.0" required="false"/>
  <virtualSignals name="event_fifo_alt_receive" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_fifo_alt_rx_int" hwSignal="alternate_receive_buffer_int" hwResource="//@hwResources.0" required="false"/>
  ...
  <virtualSignals name="sr_protocol_events" URI="http://resources/4.1.20/app/I2C_MASTER/0/vs_i2c_error_int" hwSignal="signal_in" hwResource="//@hwResources.3"/>
  ...
  <hwResources name="NVIC Node Tx" URI="http://resources/4.1.20/app/I2C_MASTER/0/hwres_nvic_node_i2c_tx" resourceGroupUri="resources/0.1.31/peripheral/cpu/0/nvic/interrupt/93" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/CPU/CPU_0.dd#//@provided.31"/>
  </hwResources>
  <hwResources name="NVIC Node Rx" URI="http://resources/4.1.20/app/I2C_MASTER/0/hwres_nvic_node_i2c_rx" resourceGroupUri="resources/0.1.31/peripheral/cpu/0/nvic/interrupt/91" mResGrpUri="peripheral/cpu/0/nvic/interrupt/*">
  ...
  <hwResources name="SDA" URI="http://resources/4.1.20/app/I2C_MASTER/0/__pin_hwres_i2c_sda" resourceGroupUri="devicepackage/0/97" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
    <downwardMapList xsi:type="ResourceModel:ResourceGroup" href="../../../HW_RESOURCES/DEVICEPACKAGE/DEVICEPACKAGE_0.dd#//@provided.16"/>
  </hwResources>
  <hwResources name="SCL" URI="http://resources/4.1.20/app/I2C_MASTER/0/__pin_hwres_i2c_scl" resourceGroupUri="devicepackage/0/95" constraintType="GLOBAL_RESOURCE" mResGrpUri="devicepackage/0/*">
